...
Podľa interného prieskumu spoločnosti Atlassian, tímy používajúce Jiru strávia o 25\% menej času na status update meetingoch, pretože informácie sú dostupné samoobslužne \cite{atlassian_roi2023}.
...
% Axes
\draw[->, thick] (0,-2.5) -- (0,4.2) node[above] {Kumulat\'{i}vny ROI};
\draw[->, thick] (-0.3,0) -- (10.5,0) node[right] {Mesiace};
...
\node[anchor=east, font=\footnotesize] at (-0.1,3.5) {$+$};

% X-axis tick labels
\foreach \x in {1,2,...,12} {
    \draw (\x*0.8, 0.08) -- (\x*0.8, -0.08);
    \node[anchor=north, font=\footnotesize] at (\x*0.8, -0.15) {\x};
}

% Fill areas: negative (cost) and positive (gain)
\fill[red!8]
    (0.8,-2) -- (0.8,-1.8) -- (1.6,-1.2) -- (2.4,-0.5) -- (2.72,0) -- (0.8, 0) -- cycle;
\fill[red!8]
    (0.8,0) -- (0.8,-2) -- (0,0-0) -- cycle;

\fill[green!10]
    (2.72,0) -- (3.2,0.4) -- (4.0,1.0) -- (4.8,1.5) -- (5.6,2.0)
    -- (6.4,2.4) -- (7.2,2.8) -- (8.0,3.1) -- (8.8,3.3) -- (9.6,3.5)
    -- (9.6,0) -- cycle;

% ROI curve
\draw[thick, blue!70!black]
    (0.8,-2) -- (1.6,-1.2) -- (2.4,-0.5) -- (2.72,0) -- (3.2,0.4)
    -- (4.0,1.0) -- (4.8,1.5) -- (5.6,2.0) -- (6.4,2.4)
    -- (7.2,2.8) -- (8.0,3.1) -- (8.8,3.3) -- (9.6,3.5);

% Break-even point
\fill[black] (2.72,0) circle (3pt);
\node[anchor=south west, font=\footnotesize\bfseries] at (2.82,0.15) {Break-even};

% Annotations
\draw[<-, black!60] (1.2,-1.6) -- (2.2,-2.2)
    node[anchor=west, font=\footnotesize, text width=2.8cm] {Licencie, konfigur\'{a}cia, onboarding};

\draw[<-, black!60] (7.2,2.8) -- (8.2,3.8)
    node[anchor=west, font=\footnotesize, text width=2.5cm] {\'{U}spory z~efekt\'{i}vnejších procesov};

\end{tikzpicture}
\caption{Graf zobrazuj\'{u}ci typick\'{y} ROI timeline po implement\'{a}cii Jiry (zdroj: vlastn\'{a} sch\'{e}ma)}
\label{fig:roi}
\end{figure}
